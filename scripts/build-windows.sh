...
package_dir="$artifact_root/BalanceCapsule-win.15-x64"
exe_path="$artifact_root/BalanceCapsule-win.15-x64.exe"
zip_path="$artifact_root/BalanceCapsule-win.15-x64.zip"
checksum_path="$artifact_root/BalanceCapsule-win.15-x64.sha256"
