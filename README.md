...
| 平台 | 系统要求 | 下载文件 |
| --- | --- | --- |
| macOS | macOS 13 或更高版本，仅 Apple Silicon | `BalanceCapsule-1.2.15-mac.13-arm64.dmg` |
| Windows | Windows 10 2004 或更高版本 / Windows 11，仅 x64 | `BalanceCapsule-1.2.15-win.13-x64.exe` |
